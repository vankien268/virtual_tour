        ...
        <section class="panel">
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                            <a href="{{ route('cms.related.locations.create') }}" class="btn btn-primary btn-block btn-full-width">Thêm địa điểm</a>
                    </div>
                    {{-- <div class="col-md-3">
    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                Danh sách địa điểm liên quan: <span class="text-danger">
                    {{ $records->count() }} 
                    /
                            ...
                            <table class="table table-bordered table-striped table-hover" id="">
                                <thead class="fc">
                                    <tr>
                                        ...
                                        <th class="text-center" width="">{{__("Địa điểm liên quan")}}</th>
                                ...
                                <tbody>
                                    @foreach ($records as $key => $record)
                                        <tr id="tr-record-{{$record->id}}">
                                            @include('cms.RelatedLocation.Component.record-table')
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
